...
from llm_rl_final_proj_old.data.ultrafeedback import GenerationExample, build_generation_examples, dataset_overview
from llm_rl_final_proj_old.models.load import (
    load_lora_policy_model_and_tokenizer,
    load_reward_model_and_tokenizer,
)
from llm_rl_final_proj_old.offline.evaluation import generate_samples, summarize_generation_rows
from llm_rl_final_proj_old.reward_model.evaluation import score_prompt_response_pairs
from llm_rl_final_proj_old.rl.base import AlgoConfig
from llm_rl_final_proj_old.rl.dr_grpo import DrGRPO
from llm_rl_final_proj_old.rl.gspo import GSPO
from llm_rl_final_proj_old.rl.grpo import GRPO
from llm_rl_final_proj_old.rl.reinforce import Reinforce
from llm_rl_final_proj_old.rollout.hf_sampler import HFSampler, SamplingConfig
from llm_rl_final_proj_old.rollout.rollout_buffer import RolloutBatch
from llm_rl_final_proj_old.utils.hardware import (
...
from llm_rl_final_proj_old.utils.seed import set_seed
from llm_rl_final_proj_old.utils.wandb_utils import WandBLogger
...
def _compute_group_advantages(
    ...
    *,
    ...
    rewards = rewards.reshape((rewards.numel()//group_size), group_size)
